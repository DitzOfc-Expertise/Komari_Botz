let handler = async (m, { conn }) => {
  let anu = `https://api.lolhuman.xyz/api/quotemaker2?apikey=gataDios&text=${pickRandom(global.galau)}&author=${conn.getName(m.sender)} 

`;
  m.reply(done, anu);
  conn.sendFile(
    m.chat,
    "https://skizo.tech/tmp/8eENj1713540653567.webm",
    "",
    null,
    m,
  );
